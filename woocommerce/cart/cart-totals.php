...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?> relative p-1">
    ...
    <div class="relative p-8 md:p-10 bg-gradient-to-b from-white/[0.03] to-transparent">
        ...
        <div class="text-center mt-6 mb-6">
            <a class="inline-flex items-center gap-2 text-slate-400 hover:text-gold transition-colors text-xs uppercase tracking-wider group" href="<?php echo esc_url( 'https://wa.me/' . get_option('emerald_whatsapp_number') ); ?>" target="_blank">
